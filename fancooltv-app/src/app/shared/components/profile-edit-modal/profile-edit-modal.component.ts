...
export class ProfileEditModalComponent implements OnInit {
    ...
    this.userService.updateProfile(updateData).subscribe({
      ...
      error: (error) => {
        ...
        if (error && error.errors) {
          ...
          this.serverErrors = this.translateErrors(error.errors);
          ...
          this.serverErrors = this.translateErrors(error.error.errors);
  ...
  translateErrors(errors: { [key: string]: string[] }): { [key: string]: string[] } {
